                    ...
                    ?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled li-space-lg">
                                    <li class="media">
                                        ...
                                        <div class="media-body">Nom Hotel :<?php echo $Hotel['nom']; ?></div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Adresse hotel: <?php echo $Hotel['adresse']; ?> </div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body"> nombre des étoiles : <?php echo $Hotel['nb_etoile']; ?> </div>
                                    </li>
                                    <li>
                                    <div class="button-group filters-button-group">
                                    <a href="index.php?id=<?php echo $Hotel['id']; ?>" class="button is-checked">Rate</a>
                                    </div>
                                   <?php 
                                    if($id ==$Hotel['id']) {
                                    ?>
                                    <form action="AjoutRate.php?id=<?php echo $Hotel['id']; ?>" method="POST">
                                            ...
                                            <Input type="Submit" Name="Submit1" VALUE="envoyer" class="form-control-submit-button">
                            ...
                            <div class="form-group ">
                                <p class="testimonial-text"><a class="white" href="chambrefront.php?id=<?php echo $Hotel['id']; ?>">les chambres </a></p>
